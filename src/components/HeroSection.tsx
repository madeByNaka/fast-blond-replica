...
const HeroSection = () => {
  ...
  return <section className="bg-gradient-to-b from-beauty-gray to-white py-16">
        ...
        <div className="text-center mb-12">
          ...
          <div className="mb-8 max-w-sm mx-auto">
            <div className="relative w-full aspect-[9/16] rounded-lg overflow-hidden shadow-lg">
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/3OWmYXu-jYU" title="Método Fast Blond - Beauty Pro Academy" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen className="absolute inset-0"></iframe>
            </div>
          </div>
