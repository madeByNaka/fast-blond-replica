        ...
        <div className="text-center mb-12">
          ...
          <div className="mb-8 max-w-sm mx-auto">
            <div className="relative w-full aspect-[9/16] rounded-lg overflow-hidden shadow-lg">
              {!showVideo ? <div className="relative w-full h-full cursor-pointer group" onClick={() => setShowVideo(true)}>
                  <img src="/lovable-uploads/af1eda59-154a-4048-b643-a9f4a763bf6b.png" alt="Método Fast Blond - Beauty Pro Academy" className="w-full h-full object-cover" />
                ...
                </div> : <iframe width="100%" height="100%" src="https://www.youtube.com/embed/3OWmYXu-jYU?autoplay=1" title="Método Fast Blond - Beauty Pro Academy" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen className="absolute inset-0" />}
            </div>
          </div>
          
          <a href={checkoutUrl} target="_blank" rel="noopener noreferrer" className="inline-block bg-gradient-to-r from-beauty-pink to-beauty-purple text-white text-xl font-bold py-4 px-8 rounded-lg hover:shadow-lg transform hover:scale-105 transition-all duration-300 animate-pulse-glow">
            Comece Agora (R$ 97)
          </a>
        </div>
      </div>
